...
function drawCell(cell) {
  ...
  switch (cell.value){
    case 0 : ctx.fillStyle = '#d1cccc'; break;
...
function finishGame() {
  ...
  loss = true;
  var r = confirm("Sorry but you lost!\nWould you like to start a new game?")
  console.log(r);
  if (r == true){
    window.location.href = "file:///Users/arno/Desktop/Coding%20Academy/Project%202048/2nd%20try/index.html";
  }
  else{}
}
